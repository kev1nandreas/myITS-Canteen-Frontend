...
export default function MonthlyReport({ revenues }: MonthlyReportProps) {
    ...
    <div className="flex gap-3 w-full mt-4">
      <div className="overflow-x-auto bg-white p-4 rounded-lg shadow-md flex-2/3">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-semibold">Tren Penjualan Setiap Bulan</h1>
          <div className="flex flex-col gap-1">
            <p className="text-sm">Jumlah Bulan</p>
            <SelectDropdown
              name="bulan"
        ...
        <LineChart
          ...
          labels_title={"Penjualan Bulanan"}
      ...
      <div className="bg-white p-4 rounded-lg shadow-md flex-1/3">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-semibold">Data Penjualan Bulanan</h1>
          <div className="flex flex-col gap-1">
